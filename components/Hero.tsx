    ...
    <div className="">
      ...
      <div className=" flex flex-col ">
        <div className="flex flex-col gap-10 mt-10 lg:mt-16 md:mt-14  lg:flex-row  md:gap-0">
          ...
          />
          <div className="flex flex-col text-4xl md:text-4xl md:mt-14   lg:my-auto lg:mx-auto items-center">
            ...
            <Button
              ...
              radius="md"
              style={gradientStyle}
              className="shadow-md w-auto h-14 font-serif mt-8 md:mt-10 lg:mt-8 text-lg md:text-xl lg:h-11 md:h-14"
            >
              Explore Exercises
            </Button>
          </div>
